const lessons = [
  ...
  {
    title: "დაწყვილება, მეტი, ნაკლები, იმდენივე",
    short: "დაწყვილება და შედარება",
...
function render() {
  ...
  if (isComparison) {
    content.innerHTML = `<iframe id="comparisonFrame" src="comparison/comparison.html?muted=${!soundOn}" title="დაწყვილება და შედარება" style="display:block;width:100%;min-height:1050px;height:1100px;border:0"></iframe>`;
    return;
  }
