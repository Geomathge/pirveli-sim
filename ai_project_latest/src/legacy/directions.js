...
function renderVerticalStairsLearn() {
  ...
  content.innerHTML = `
    <div class="stage-panel stair-stage">
      <div class="activity-area">
        <div class="instruction child-instruction"><span class="instruction-number">1</span><div><h3>ადი ზევით. ჩამოდი ქვევით.</h3><p>ისარს ერთხელ დააჭირე — ერთი საფეხური.</p></div>${audioButton("ადი ერთი საფეხურით ზევით. ჩამოდი ერთი საფეხურით ქვევით.")}</div>
        <div class="dual-stair-board">
          <section class="stair-demo-card up-demo" data-stair-demo="up">
            <h4>${verticalActor === "rabbit" ? "კურდღელი ასკუპდება ზევით" : "გოგო ადის ზევით"}</h4>
            <div class="stair-demo-action">
              ${staircaseMarkup(upStairLevel, "upStairAvatar", "up")}
              <button class="stair-control stair-up" type="button" data-stair-move="up" aria-label="გოგო ერთი საფეხურით ზევით"><span>↑</span><small>ზევით</small></button>
            </div>
          </section>
          <section class="stair-demo-card down-demo" data-stair-demo="down">
            <h4>${verticalActor === "rabbit" ? "კურდღელი ჩამოსკუპდება ქვევით" : "ბიჭი ჩამოდის ქვევით"}</h4>
            <div class="stair-demo-action">
              ${staircaseMarkup(downStairLevel, "downStairAvatar", "down")}
              <button class="stair-control stair-down" type="button" data-stair-move="down" aria-label="ბიჭი ერთი საფეხურით ქვევით"><span>↓</span><small>ქვევით</small></button>
            </div>
          </section>
        </div>
        <details class="hint-box">
          ...
          <div class="hint-content">
            ↑ ზევით ადის. ↓ ქვევით ჩამოდის. თითო დაჭერა — ერთი საფეხური.
          </div>
        </details>
        <div class="feedback" id="feedback" hidden></div>
      </div>
      <aside class="side-note book-stair-note">
        <div class="speech"><strong>წიგნის მოდელი</strong>კიბეზე რიცხვები 1-იდან 5-მდე იზრდება.</div>
        <figure><img src="assets/book/staircase-up-book.png" alt="წიგნის ნახატი: მოსწავლე კიბეზე ზევით ადის"><figcaption>ზევით ასვლა</figcaption></figure>
        <figure><img src="assets/book/staircase-down-book.png" alt="წიგნის ნახატი: მოსწავლე კიბეზე ქვევით ჩამოდის"><figcaption>ქვევით ჩამოსვლა</figcaption></figure>
  ...
  announce("ადი ზევით. ჩამოდი ქვევით.");
}
...
function renderVerticalPractice() {
  ...
  content.innerHTML = `
    <div class="stage-panel stair-stage">
      <div class="activity-area">
        <div class="instruction child-instruction practice-command"><span class="instruction-number">2</span><div><h3>ამოძრავე კურდღელი ზევით და ქვევით.</h3><p>თითო დაჭერაზე კურდღელი ერთ საფეხურზე ასკუპდება ან ჩამოსკუპდება.</p></div>${audioButton("ამოძრავე კურდღელი ზევით და ქვევით. თითო დაჭერაზე გაიარე ერთი საფეხური.")}</div>
        <div class="dual-stair-board practice-dual-stairs">
          <section class="stair-demo-card up-demo" data-stair-demo="up">
            <h4>კურდღელი ასკუპდება ზევით</h4>
            <div class="stair-demo-action">
              ${staircaseMarkup(upStairLevel, "practiceUpStairAvatar", "up")}
              <button class="stair-control stair-up" type="button" data-stair-move="up" data-practice-stair-move="up" aria-label="ერთი საფეხურით ზევით"><span>↑</span><small>ზევით</small></button>
            </div>
          </section>
          <section class="stair-demo-card down-demo" data-stair-demo="down">
            ...
            <div class="stair-demo-action">
              ...
              <button class="stair-control stair-down" type="button" data-stair-move="down" data-practice-stair-move="down" aria-label="ერთი საფეხურით ქვევით"><span>↓</span><small>ქვევით</small></button>
            </div>
          </section>
        </div>
        <details class="hint-box">
      ...
      <aside class="side-note picture-note">
        <div class="check-progress"><strong id="stairPracticeProgress">${Math.min(verticalPracticeMoves.up, 2) + Math.min(verticalPracticeMoves.down, 2)} / 4</strong><div>${Array.from({ length: 4 }, (_, index) => `<i class="${index < Math.min(verticalPracticeMoves.up, 2) + Math.min(verticalPracticeMoves.down, 2) ? "done" : ""}" data-practice-dot></i>`).join("")}</div></div>
        <div class="speech"><strong>ივარჯიშე ორივე მიმართულებით</strong>კურდღელი ორჯერ აასკუპე ზევით და ორჯერ ჩამოსკუპე ქვევით.</div>
